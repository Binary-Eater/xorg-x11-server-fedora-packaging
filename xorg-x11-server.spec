...
Patch6013: xserver-1.5.3-new-automake.patch
...
%changelog
* Mon Nov 23 2009 Adam Jackson <ajax@redhat.com> 1.5.3-18
- xserver-1.5.3-new-automake.patch: Fix build with new automake. (#508758)
